...
switch(type){
        case 'mithril':
                ...
                files:['./picture/mithril.png','./picture/res_mithril.png'], 
                ephemeral: true
                });
                break;
        case 'steel':
                ...
                files:['./picture/steel.png','./picture/res_steel.png'], 
                ephemeral: true
                });
                break;
        case 'reinforced_obsidian':
                interaction.reply({ 
                content: "強化黒曜石\n必要素材:黒曜石x8、ダイヤモンドx1",
                files:['./picture/reinforced_obsidian.png','./picture/res_reinforced_obsidian.png'], 
                ephemeral: true
                });
                break;
        case 'narikin':
                interaction.reply({ 
                content: "$成金ブロック$\n必要素材:圧縮金ブロックx9",
                files:['./picture/narikin.png','./picture/res_narikin.png'], 
                ephemeral: true
                });
                break;
        case 'complex_ore':
                ...
                files:['./picture/complex_ore.png','./picture/res_complex_ore.png'], 
                ephemeral: true
                });
                break;
        case 'ripe_red_complex_ore':
                ...
                files:['./picture/ripe_red_complex_ore.png','./picture/res_ripe_red_complex_ore.png'], 
                ephemeral: true
                });
                break;
        case 'super_strong_coolant':
                ...
                files:['./picture/super_strong_coolant.png','./picture/res_super_strong_coolant.png'], 
                ephemeral: true
                });
                break;
        case 'orichalcum':
                ...
                files:['./picture/orichalcum.png','./picture/res_orichalcum.png'], 
                ephemeral: true
                });
                break;
        case 'blue_magical_power':
                interaction.reply({ 
                content: "青き魔力の源\n必要素材:圧縮ラピスブロックx9",
                files:['./picture/blue_magical_power.png','./picture/res_blue_magical_power.png'], 
                ephemeral: true
                });
                break;
        case 'red_burning_power':
                ...
                files:['./picture/red_burning_power.png','./picture/res_red_burning_power.png'], 
                ephemeral: true
                });
                break;
        case 'majicatron_crystal':
                ...
                files:['./picture/majicatron_crystal.png','./picture/res_majicatron_crystal.png'], 
                ephemeral: true
                });
                break;
        case 'water_ticket':
                ...
                files:['./picture/water_ticket.png','./picture/res_water_ticket.png'], 
                ephemeral: true
                });
                break;
        case 'ocean_heart':
                ...
                files:['./picture/ocean_heart.png','./picture/res_ocean_heart.png'], 
                ephemeral: true
                });
                break;
        case 'sponge':
                ...
                files:['./picture/sponge.png','./picture/res_sponge.png'], 
                ephemeral: true
                });
                break;
        case 'super_duranium_drill':
                ...
                files:['./picture/super_duranium_drill.png','./picture/res_super_duranium_drill.png'], 
                ephemeral: true
                });
                break;
        case 'super_duranium_drill_upgrade':
                ...
                files:['./picture/super_duranium_drill.png','./picture/res_super_duranium_drill_upgrade.png'], 
                ephemeral: true
                });
                break;
        case 'axe_of_helmes':
                ...
                files:['./picture/axe_of_helmes.png','./picture/res_axe_of_helmes.png'], 
                ephemeral: true
                });
                break;
        case 'ice_sword':
                ...
                files:['./picture/ice_sword.png','./picture/res_ice_sword.png'], 
                ephemeral: true
                });
                break;
        case 'cure_stick':
                ...
                files:['./picture/cure_stick.png','./picture/res_cure_stick.png'], 
                ephemeral: true
                });
                break;
        case 'godly_mana_rod':
                ...
                files:['./picture/godly_mana_rod.png','./picture/res_godly_mana_rod.png'],
                ephemeral: true
                });
                break;
        default:
